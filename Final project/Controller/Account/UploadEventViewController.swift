...
class UploadEventViewController: UIViewController {
    ...
    func setEventTitleTextField(isSettingAttributes: Bool) {
        if isSettingAttributes {
            ...
            eventTitleTextField.frame = CGRect(x: 10, y: currentHeightScrollable, width: view.frame.width, height: 40)
    ...
    func setEventDescriptionTextField(isSettingAttributes: Bool) {
        if isSettingAttributes {
            ...
            eventDescriptionTextField.frame = CGRect(x: 10, y: currentHeightScrollable, width: view.frame.width, height: 300)
    ...
    func setEventDateTextField(isSettingAttributes: Bool) {
        if isSettingAttributes {
            ...
            eventDateTextField.frame = CGRect(x: 10, y: currentHeightScrollable, width: view.frame.width - 10, height: 50)
    ...
    func setEventTimeTextField(isSettingAttributes: Bool) {
        if isSettingAttributes {
            ...
            eventTimeTextField.frame = CGRect(x: 10, y: currentHeightScrollable, width: view.frame.width - 10, height: 50)
